    ...
    <div class="section-body">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header bg-white">
                        <h4 class="text-success">Jumlah Transaksi Per Bulan</h4>
                    </div>
                    <div class="card-body p-2">
...
<script>
    ...
    var transactionChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: {!! json_encode($transaksi_per_bulan->pluck('bulan')->map(function ($date) { return \Carbon\Carbon::parse($date)->format('M Y'); })) !!},
            datasets: [{
                label: 'Jumlah Transaksi',
                data: {!! json_encode($transaksi_per_bulan->pluck('total')) !!},
